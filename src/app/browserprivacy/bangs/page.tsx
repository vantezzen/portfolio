...
export const metadata = legalMetadata("Privacy policy for Bangs for Google");

export default function BangsPrivacyPage() {
  return (
    <LegalPage
      title="Privacy policy for Bangs for Google"
      updated="November 3, 2020"
    >
      <h2>A small letter from the creators of the extension</h2>
      <p>
      ...
      <p>
        ...
        simply redirect you to DuckDuckGo whenever your query starts with a “!”.
      </p>

      <h2>Introducing the Privacy Policy</h2>
      <p>
        This privacy policy (“Privacy Policy”) explains how Bangs for Google
        (“extension”, “browser extension” or “we”) collects and uses information
      ...
      <p>
        ...
        connection with your use of the extension, regardless of how you access
        or use them. Please read this Privacy Policy carefully so that you
        understand your rights in relation to how we use and process information
        that you share and that we collect.
      </p>
      <p>
      ...
      <h2>About us</h2>
      <p>
        The party responsible for this extension (the “controller”) for purposes
      ...
      <p>
        Our browser extension uses your search query whenever you visit Google.
        This data will not be sent to any of our servers. Instead, we locally
        check if the query starts with a “!” and redirect you to DuckDuckGo if
        that is the case.
      </p>
      <p>
      ...
      <p>
        We only collect the query locally. This means we do not collect any data
        on e.g. your search history, your emails, your credit card information
        or other information about your browser.
      </p>
      ...
      <p>
        ...
        18, please do not attempt to use this extension or send any personal
