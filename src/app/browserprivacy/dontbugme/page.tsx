...
export const metadata = legalMetadata("Privacy policy for Don’t Bug Me");

export default function DontBugMePrivacyPage() {
  return (
    <LegalPage title="Privacy policy for Don’t Bug Me" updated="June 25, 2019">
      <h2>A small letter from the creators of DontBugMe</h2>
      <p>
        DontBugMe was created to improve your privacy online, not limit it. This
        is why we dispense with using analytics in our extension and do not sell
        your personal data to anyone.
      </p>
      <p>
        We do however need to send your current website to BugMeNot to get
        credentials available for this domain. As we do still want you to have
      ...
      <p>
        ...
        (“DontBugMe”, “browser extension” or “we”) collects and uses information
      ...
      <p>
        ...
        e.g. <code>example.com</code>) when you
      </p>
      <ul>
        <li>
          open the browser popup, e.g. by clicking on the DontBugMe icon in your
          browser toolbar
        </li>
        <li>
          enable “Automatically check for available accounts and show badge”. In
          this case, DontBugMe will collect your current TLD every time you open
          a new website or switch browser tabs or windows.
        </li>
      </ul>
      <p>
      ...
      <p>
        We only collect the TLD of your current tab or window. This means we do
        not collect any data on e.g. your search history, your emails, your
      ...
      <h2>How we share your information with third parties</h2>
      <p>
        Our browser extension will share your current TLD with{" "}
        <code>BugMeNot.com</code> in order to get a list of available accounts.
        In order for this to happen, your browser will send a request to{" "}
        <code>http://bugmenot.com/view/[TLD]</code>, replacing{" "}
        <code>[TLD]</code> with your current TLD, e.g. <code>example.com</code>.
      </p>
      <p>
      ...
      <ul>
        <li>
          You open the browser popup, e.g. by clicking on the DontBugMe icon in
          your browser toolbar
        </li>
        <li>
          You enable “Automatically check for available accounts and show
          ...
          got back from <code>BugMeNot.com</code> for a limited time in order to
          not send a new request every time you open the same TLD.
        </li>
      </ul>
      <p>
        For more information on how <code>BugMeNot.com</code> will process your
        data, please visit{" "}
        <a
          href="http://bugmenot.com/terms.php"
          target="_blank"
      ...
      <h2>Children</h2>
      <p>
        We created DontBugMe for the exclusive use of adults aged 18 and older.
        ...
        18, please do not attempt to use DontBugMe or send any personal
