<script>
	...
	let textHighlight = 'text-orange-600 font-bold';
</script>
...
<Section title="Tech">
	...
	<p class="mt-6 font-medium">
		As part of my study of applied computer science, I got to learn a lot of different technologies,
		including
	...
	<p class="mt-6 font-medium">
		Additionally, through contributions on open-source projects I got to work with <span
			class={textHighlight}>Electron.js</span
		>
		for developing desktop apps,
		<span class={textHighlight}>react-native</span> for developing mobile apps and
		<span class={textHighlight}> various other JavaScript libraries </span>
	...
	<p class="mt-6 font-medium">
		...
		<span class={textHighlight}>Figma</span> for designing user interfaces,
		<span class={textHighlight}>Adobe Illustrator</span>
		for designing logos and other brand assets as well as
		<span class={textHighlight}>Photoshop</span> .
	</p>
</Section>
