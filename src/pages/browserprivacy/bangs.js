...
const Impressum = () => (
  <>
    ...
    <Container>
      ...
      <h1>Privacy policy for "Bangs for Google".</h1>
      ...
      <p>"Bangs for Google" was created to help you use Google - not limit your privacy. This is why we dispense with using analytics in our extension and do not sell your personal data to anyone.</p>

      <p>We never store any of your search queries or other browsing data but simply redirect your to DuckDuckGo whenever your query start with a "!".</p>

      <h2 id="introducingtheprivacypolicy">Introducing the Privacy Policy</h2>

      <p>This privacy policy ("Privacy Policy") explains how "Bangs for Google" ("extension", "browser extension" or "we") collects and uses information from users of the browser extension.</p>
      ...
      <p>Our browser extension uses your search query whenever you visit Google. This data will not be sent to any of our servers. Instead, we locally check, if the query starts with a "!" and redirect you to DuckDuckGo if that is the case.</p>
      ...
      <p>We only collect the query locally. This means we do not collect any data on e.g. your search history, your emails, your credit card information or other information about your browser.</p>
