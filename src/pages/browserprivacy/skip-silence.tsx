    ...
    <Layout>
      <PageCard>
        ...
        <h1 className="font-bold text-3xl">
          Privacy policy for "Skip Silence".
        </h1>
        <blockquote>
        ...
        <p>
          Skip Silence doesn't send any data about you or your videos to us!
        </p>

        <h2 id="introducingtheprivacypolicy">Introducing the Privacy Policy</h2>

        <p>
          This privacy policy ("Privacy Policy") explains how Skip Silence
          ("Skip Silence", "browser extension" or "we") collects and uses
        ...
        <p>
          ...
          how you access or use them. Please read this Privacy Policy carefully
          so that you understand your rights in relation to how we use and
          process information that you share and that we collect.
        </p>
        ...
        <p>
          The extension will then monitor the volume of the media to slow it up
          or down. The information about your media is never sent anywhere and
          is only kept on your computer.
        </p>

        <p>
          Additionally, our browser extension saves the settings you set using{" "}
          <a href="https://developer.chrome.com/apps/storage">
        ...
        <p>
          We do not collect any information about what media you watch or how
          you use our extension. Your data remains with you and we never have
          access.
        </p>
        ...
        <p>
          ...
          under 18, please do not attempt to use Skip Silence or send any
