...
function Privacy() {
  return (
    <Layout>
      <PageCard>
        <Helmet>
          <title>Datenschutzerklärung - Hollstein</title>
        ...
        <p>
          Wir verwenden Google reCAPTCHA der Firma Google Inc. (1600
          Amphitheatre Parkway Mountain View, CA 94043, USA) um Spam zu
          verhindern.
        </p>
        <p>
        ...
        <p>
          ...
          Missbrauch schützt. Es nutzt fortschrittliche Risikoanalysetechniken,
          um Menschen und Bots auseinander zu halten. Mit der neuen API wird
          eine signifikante Anzahl Ihrer gültigen menschlichen Benutzer die
          reCAPTCHA-Herausforderung bestehen, ohne ein CAPTCHA lösen zu
        ...
        <p>
          ...
          <a href="https://www.netlify.com">Netlify</a>. Bitte beachten Sie
          hierfür die{" "}
        ...
        <p>
          ...
          <a href="https://minimalpedia.vantezzen.io/">
            https://minimalpedia.vantezzen.io/
          </a>{" "}
          bereitgestellt wird.
        </p>
        <p>
